...
class FirebaseImageUploaderTest {
    ...
    @Test
    fun `uploadImage should return Success with download URL on successful upload`() =
        runTest {
            val uri = mockk<Uri>()
    ...
    @Test
    fun `uploadImage should return Error when upload fails`() =
        runTest {
            val uri = mockk<Uri>()
            val uploadTask = mockk<UploadTask>()
    ...
    @Test
    fun `deleteImage should return Success on successful delete`() =
        runTest {
    ...
    @Test
    fun `deleteImage should return Error when delete fails`() =
        runTest {
            val imageUrl = "https://firebase.com/test-image.jpg"
            val imageRef = mockk<StorageReference>()
            val deleteTask = mockk<Task<Void>>()
    ...
    @Test
    fun `uploadImage creates correct storage path`() =
        runTest {
            val uri = mockk<Uri>()
            val uploadTask = mockk<UploadTask>()
            val downloadUrlTask = mockk<Task<Uri>>()
